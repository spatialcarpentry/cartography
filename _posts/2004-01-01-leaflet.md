...
<p><img src="{{site.baseurl}}{{ASSET_PATH}}/images/logo-leaflet.png" /></p>
...
<img src="{{site.baseurl}}{{ASSET_PATH}}/images/geojson.png" />
...
<ol>
  ...
  <li>Save As .geojson into your working directory:</li>
    <ol>
      ...
      <img src="{{site.baseurl}}{{ASSET_PATH}}/images/export-geojson.png" />
      </li>
    </ol>
  ...
  <li>Open us_states.js in a text editor (not Microsoft Word!) and create a JavaScript variable to call our US States data. The following JavaScript <em>must</em> be entered correctly, one small error and you will not be loading a layer into Leaflet:<br>
    <ol>
      ...
      <img src="{{site.baseurl}}{{ASSET_PATH}}/images/var-us-states.png" /><br>
      <img src="{{site.baseurl}}{{ASSET_PATH}}/images/var-us-states-2.png" />
      </li>
...
<ol>
  ...
  <ul>
    ...
    <img src="{{site.baseurl}}{{ASSET_PATH}}/images/us-states.png"/>
    </li>
  </ul>
  </li>
</ol>
...
<img src="{{site.baseurl}}{{ASSET_PATH}}/images/wa-tracts.png"/>
<br>
<br>
<hr>
