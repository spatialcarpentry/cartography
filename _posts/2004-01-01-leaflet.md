...
<!--
<h4>Data:</h4>
<p>iRods access<br>&nbsp;&nbsp;&nbsp;<code>/iplant/home/shared/aegis/Spatial-bootcamp/cartography/leaflet-exercise</code></p>
<ul>
  <li>one</li>
  <li>two</li>
  <li>three</li>
...
<div><pre><code><span>var wa_tracts = [ </span>
...
<div><pre><code><span>&lt;script src="wa_tracts.js"&gt;&lt;/script&gt;</span></code></pre></div></li>
<li>Define your map with center and zoom level within SCRIPT within BODY:<br>
<div><pre><code>var map = L.map('map').setView([47.493,-120.563], 7);</code></pre></div></li>
<li>Add a basemap within SCRIPT within BODY:<br>
<div><pre><code><span>var grayScale = L.tileLayer('https://{s}.tiles.mapbox.com/v3/{id}/{z}/{x}/{y}.png', {
attribution: 'Map data copywright &lt;a href="http://openstreetmap.org"&gt;OpenStreetMap&lt;/a&gt; contributors, ' +
'&lt;a href="http://creativecommons.org/licenses/by-sa/2.0/"&gt;CC-BY-SA&lt;/a&gt;, ' +
'Imagery copywright &lt;a href="http://mapbox.com"&gt;Mapbox&lt;/a',
...
<div>
<pre>
<code><span>&lt;!DOCTYPE html&gt;</span><br>
<span>&lt;html&gt;</span><br>
